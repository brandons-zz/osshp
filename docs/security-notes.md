...
All three are safe under osshp's single-admin threat model. They are
documented here so the operational disciplines they depend on — strong
generation, separate passphrase storage, cron-secret hygiene — are visible
choices, not hidden assumptions.
