...
export function MarkdownHelp() {
  ...
  // Explicit two-direction focus trap (defect 5). Self-gates on dialog.open, so
  // it works with this shell's imperative open/close (no `open` prop).
  ...
  return (
    <>
      ...
      <dialog
        ...
        // (see confirm-dialog.tsx — Chromium makes overflow:auto dialogs a
        // focusable scroll container; defect 5).
        tabIndex={-1}
