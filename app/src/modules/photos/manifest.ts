...
export const photosModule: ModuleManifest = {
  ...
  // Public masthead-nav suggestion (issue 053) — offered to the Settings nav
  // editor as a one-click "Add Photos" so a published photo at /photos is
  // reachable from the public site. Owner keeps control (add/reorder/remove).
  publicNav: [{ label: "Photos", href: "/photos", order: 30 }],
