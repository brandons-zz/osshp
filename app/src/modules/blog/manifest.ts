...
export const blogModule: ModuleManifest = {
  ...
  // editor as a one-click "Add Blog" so the public reading index at /blog is
  // reachable from the site nav. Owner keeps control (add/reorder/remove).
  publicNav: [{ label: "Blog", href: "/blog", order: 10 }],
