...
import { buildImageMarkdown } from "@/lib/client/upload-image";
...
export function PageEditor({
  ...
  // Media picker (issue 037) — insert an image into the Markdown body.
  ...
  return (
    <div className="stack">
      ...
      <MediaPicker
        ...
        primaryLabel="Insert"
        onSelect={(picked) => {
          // Insert Markdown at the cursor in the code-block body (§3.4); renders
          // in the Preview pane through the existing pipeline.
          editor
            ?.chain()
            .focus()
            .insertContent({
